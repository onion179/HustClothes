                                ...
                                <div class="product-details">
                                    ...
                                    <div class="quantity">
                                        <div class="quantity">
                                            ...
                                            <a href="#" class="primary-btn pd-cart">Giỏ Hàng</a>
                                        </div>
                                    </div>
                                    <ul class="pd-tags">
                        ...
                        <div class="product-tab">
                            <div class="tab-item">
                                <ul class="nav" role="tablist">
                                    ...
                                    <li>
                                        <a href="#tab-3" data-toggle="tab" role="tab">Đánh Giá Của Khách ({{count($product->productComments)}})</a>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <div class="leave-comment">
                                                ...
                                                <form action="" method="post" class="comment-form">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <textarea placeholder="Tin Nhắn" name="messages"></textarea>
