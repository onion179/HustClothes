...
@section('body')
    ...
    <section class="product-shop spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 product-slider-filter">
                                ...
                                <form action="">
                                    <div class="select-option">
                                        <select name="sort_by" onchange="this.form.submit();" class="sorting">
                                            ...
                                            <option {{request('sort_by') =='price-ascending' ? 'selected' : ''}} value="price-ascending">Sắp Xếp: Giá (Thấp - Cao</option>
                                            <option {{request('sort_by') =='price-descending' ? 'selected' : ''}} value="price-descending">Sắp Xếp: Giá (Cao - Thấp)</option>
                                        </select>
